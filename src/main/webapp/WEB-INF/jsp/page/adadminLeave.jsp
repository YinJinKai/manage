...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/lib/css/adadminleave.css" />
<link rel="stylesheet" type="text/css"
...
<script src="<%=request.getContextPath()%>/lib/js/tools.js"
	type="text/javascript" charset="utf-8"></script>
<script src="<%=request.getContextPath()%>/lib/js/adadminleave.js"
	type="text/javascript" charset="utf-8"></script>
</head>
<body class="easyui-layout">
		<div class="add_new" data-options="region:'north',collapsible: false" style="background:#eee;">
		 <div class="inadd">
		    <a id="btn" href="#" onclick="pass('a2')" style="width: 100px;height: 30px;">通过</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a id="btn2" href="#" onclick="pass('a1')" style="width: 100px;height: 30px;">驳回</a>
		...
		<div data-options="region:'west',collapsible: false" style="width:180px;overflow: hidden;background:#eee;">
			<ul class="menubox">
				<li>
					<a id="myleave" onclick="selectLeave('t2')">待审批的申请</a>
				</li>
				<li>
					<a id="adminnoleave" onclick="selectLeave('a1')">您已驳的回申请</a>
				</li>
				<li>
					<a id="teacherpass" onclick="selectLeave('a2')">您通过的申请</a>
				</li>
			</ul>
		</div>
